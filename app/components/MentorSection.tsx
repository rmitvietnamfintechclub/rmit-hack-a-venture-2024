        ...
        <div className="text-white flex flex-col items-center justify-center md:mt-[120px] max-md:px-[16px] md:mb-[400px] max-md:my-[68px]">
            ...
            <div className='md:flex md:flex-wrap md:gap-5 text-white max-md:grid max-md:grid-cols-2 mx-auto justify-center items-start max-md:gap-[12px] md:mt-[40px]'>
                <div className="md:w-[250px] max-md:py-[16px] text-center">
                    <Image src="/Long_Dang.jpg" alt="Mr. Long Dang" className="w-full h-auto rounded-xl mb-4 object-cover" width={200} height={200} />
                ...
                <div className="md:w-[250px] max-md:py-[16px] text-center">
                    <Image src="/Nam_Nguyen.jpg" alt="Mr. Nam Nguyen" className="w-full h-auto rounded-xl mb-4 object-cover" width={200} height={200} />
                ...
                <div className="md:w-[250px] max-md:py-[16px] text-center">
                    <Image src="/tin_nguyen.png" alt="Mr. Tin Nguyen" className="w-full h-auto rounded-xl mb-4 object-cover" width={200} height={200} />
