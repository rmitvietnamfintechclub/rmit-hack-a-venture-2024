...
const LaptopNav = () => {
	...
	return (
		<nav
			id="header"
			className="px-[250px] sticky z-50 top-0 w-full h-[72px] backdrop-blur-sm bg-black/30 border-b-[1px] border-solid border-[#374051] text-[14px] hidden lg:flex justify-between items-center gap-[100px]"
		>
			{/*-----------------------------left side ------------------------*/}
...
const MobileNav = () => {
	...
	return (
		<section className="lg:hidden flex justify-between items-center  sticky top-0 z-50">
			<nav className=" max-md:px-[20px] w-full h-[72px] backdrop-blur-sm bg-black/30 border-b-[1px] border-solid border-[#374051] flex justify-between items-center">
				{/*---------- mobile logo ----------*/}
